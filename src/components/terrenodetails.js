  ...
  if (!terreno) {
    return (
      <Container sx={{ py: 4, textAlign: 'center' }}>
        <Typography variant="h6" color="error">Terreno no encontrado.</Typography>
      </Container>
    );
  }
    ...
    <Container maxWidth="sm" sx={{
      ...
      <Paper elevation={2} sx={{
          ...
          {terreno.images && terreno.images.length > 0 ? (
            <>
              ...
              <Grid container spacing={1} justifyContent="center">
                {terreno.images.slice(1).map((img, index) => (
                  <Grid item xs={3} sm={2.5} md={2} key={index}>
                    <Box
                      ...
                      <img
                        src={img}
                        alt={`${terreno.title} thumbnail ${index + 2}`}
                        style={{
                          width: '100%',
                          height: '100%',
                          objectFit: 'cover',
        ...
        <Typography sx={{
          ...
          Descripción: {terreno.description}
        </Typography>
        {terreno.details && (
          <Box sx={{
            display: 'flex',
            ...
            color: 'black',
              ...
              <Typography component="span" sx={{ ml: 0.25, color: 'black'}}>
                  Detalles Adicionales: {terreno.details}
              </Typography>
          </Box>
        )}
